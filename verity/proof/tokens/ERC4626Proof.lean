...
open common.ERC4626Concrete
open common.ERC4626Ghost
...
attribute [local simp] src.tokens.safeTransfer src.tokens.safeTransferFrom
  src.tokens.traceERC4626AssetSafeTransfer src.tokens.traceERC4626AssetSafeTransferFrom
  src.tokens.erc4626AssetSafeTransferEvent src.tokens.erc4626AssetSafeTransferFromEvent
...
theorem approve_succeeds (spender : Address) (amount : Uint256) (s : ContractState) :
  erc4626_approve_succeeds spender amount s ((src.tokens.ERC4626.approve spender amount).run s) := by
  simpa [erc4626_approve_succeeds, src.tokens.ERC4626.approve, src.tokens.ERC20.approve]
...
theorem approve_sets_allowance (spender : Address) (amount : Uint256) (s : ContractState) :
  erc4626_approve_sets_allowance spender amount s ((src.tokens.ERC4626.approve spender amount).run s) := by
  simpa [erc4626_approve_sets_allowance, src.tokens.ERC4626.approve, src.tokens.ERC20.approve]
...
theorem approve_keeps_balances (spender : Address) (amount : Uint256) (s : ContractState) :
  erc4626_approve_keeps_balances spender amount s ((src.tokens.ERC4626.approve spender amount).run s) := by
  simpa [erc4626_approve_keeps_balances, src.tokens.ERC4626.approve, src.tokens.ERC20.approve]
...
theorem approve_keeps_total_supply (spender : Address) (amount : Uint256) (s : ContractState) :
  erc4626_approve_keeps_total_supply spender amount s ((src.tokens.ERC4626.approve spender amount).run s) := by
  simpa [erc4626_approve_keeps_total_supply, src.tokens.ERC4626.approve, src.tokens.ERC20.approve]
...
theorem transfer_reverts_when_balance_is_low
  ...
  erc4626_transfer_reverts_when_balance_is_low toAddr amount s ((src.tokens.ERC4626.transfer toAddr amount).run s) := by
  simpa [erc4626_transfer_reverts_when_balance_is_low, src.tokens.ERC4626.transfer, src.tokens.ERC20.transfer]
...
theorem transfer_to_self_keeps_balances
    (toAddr : Address) (amount : Uint256) (s : ContractState) :
  erc4626_transfer_to_self_keeps_balances toAddr amount s ((src.tokens.ERC4626.transfer toAddr amount).run s) := by
  simpa [erc4626_transfer_to_self_keeps_balances, src.tokens.ERC4626.transfer, src.tokens.ERC20.transfer]
...
theorem transfer_reverts_when_recipient_balance_would_overflow
  ...
  erc4626_transfer_reverts_when_recipient_balance_would_overflow toAddr amount s
    ((src.tokens.ERC4626.transfer toAddr amount).run s) := by
  simpa [erc4626_transfer_reverts_when_recipient_balance_would_overflow,
    src.tokens.ERC4626.transfer, src.tokens.ERC20.transfer]
...
theorem transfer_keeps_total_supply
    (toAddr : Address) (amount : Uint256) (s : ContractState) :
  erc4626_transfer_keeps_total_supply toAddr amount s ((src.tokens.ERC4626.transfer toAddr amount).run s) := by
  simpa [erc4626_transfer_keeps_total_supply, src.tokens.ERC4626.transfer, src.tokens.ERC20.transfer]
...
theorem transferFrom_reverts_when_allowance_is_low
  ...
  simpa [erc4626_transferFrom_reverts_when_allowance_is_low,
    src.tokens.ERC4626.transferFrom, src.tokens.ERC20.transferFrom]
...
private theorem approve_keeps_token_supply_storage
  ...
  simpa [erc4626_approve_keeps_total_supply,
    spec.tokens.ERC20Spec.erc20_approve_keeps_total_supply,
    src.tokens.ERC20.tokenSupply, tokenSupply]
...
private theorem transfer_keeps_token_supply_storage
  ...
  simpa [erc4626_transfer_keeps_total_supply,
    spec.tokens.ERC20Spec.erc20_transfer_keeps_total_supply,
    src.tokens.ERC20.tokenSupply, tokenSupply]
...
private theorem transferFrom_keeps_token_supply_storage
  ...
  ((transferFrom fromAddr toAddr amount).run s).snd.storage tokenSupply.slot =
    s.storage tokenSupply.slot := by
  simpa [erc4626_transferFrom_keeps_total_supply,
    spec.tokens.ERC20Spec.erc20_transferFrom_keeps_total_supply,
    src.tokens.ERC20.tokenSupply, tokenSupply]
