...
namespace common.ERC4626Concrete
...
def hasSafeTransferFromTrace
  ...
  assetTraceContains
    (src.tokens.erc4626AssetSafeTransferFromEvent asset fromAddr toAddr amount)
    s.events
...
def hasSafeTransferTrace
    ...
    (s : ContractState) : Prop :=
  assetTraceContains
    (src.tokens.erc4626AssetSafeTransferEvent asset fromAddr toAddr amount)
    s.events
